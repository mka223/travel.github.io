      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-center" aria-labelledby="navbarDropdownProfile">
              <a class="dropdown-item" href="recpayment.php">Recieved Payments</a>
              <a class="dropdown-item" href="pendpayment.php">Pending Payments</a>
            </div>
          </li>
        </ul>
      </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">Payments From User</h4>
            </div>
            <div class="card-body">
              <div id="typography">
